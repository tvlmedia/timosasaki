      ...
      <div className="grid gap-4 xl:grid-cols-[1.1fr_0.9fr]">
        ...
        <div className="space-y-4">
          ...
          <div className="panel grid gap-2 p-4">
            <Link href={`/projects/${project.id}/stack`} className="inline-flex">
              <Button variant="primary" className="w-full">
                Edit Stack
              </Button>
            </Link>
            <Link href={`/projects/${project.id}/cad`} className="inline-flex">
              <Button className="w-full">Generate CAD</Button>
            </Link>
            <Link href={`/projects/${project.id}/experiments`} className="inline-flex">
